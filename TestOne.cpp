...
BEGIN_MESSAGE_MAP(CTestOneApp, CWinApp)
...
CTestOneApp::CTestOneApp()
{
	...
	HBITMAP hBitmap1 = (HBITMAP)::LoadImage(
		NULL
		, _T("wolf.bmp")
		, IMAGE_BITMAP
		, 0
	...
	HBITMAP hBitmap3 = (HBITMAP)::LoadImage(
		NULL
		, _T("bound_tree.bmp")
		, IMAGE_BITMAP
		, 0
